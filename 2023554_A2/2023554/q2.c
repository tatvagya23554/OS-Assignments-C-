...
void translateAddress(unsigned int logical_address){
    ...
    unsigned int physical_address = 0;//Physical address = Base + (Virtual Address - Segment Start Address) : paranthesis part is offset
...
int main(){//4000 logical address has 8800 as logical address
