...
uint32_t* page_directory[PD_TOTAL_ENTRIES];//An array of pointers
...
int main(){
    ...
    do so in the store function*/
    //8 bit values as virtual addresses
    ...
    uint8_t second_value = load(0x00000321);//67891A4F
    printf("\n");

    //conversion character for hexadecimal number in all caps: X
    printf("Value loaded using VA 0x00000321: 0x%02X\n", first_value);
    printf("Value loaded using VA 0x00000321: 0x%02X\n", second_value);//67891A4F
    printf("\n");
